...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-07-2015 a las 09:48:24
...
(12, 1, 2, 'ss', '2', '2015-07-06', 'Change your values', 3, '0'),
(13, 1, 2, 'bug', '1', '2015-07-15', 'Change your theory', 3, '1');
...
--
-- Indices de la tabla `forum-post`
--
...
--
-- Indices de la tabla `test-cursos`
--
ALTER TABLE `test-cursos`
 ADD PRIMARY KEY (`id`);

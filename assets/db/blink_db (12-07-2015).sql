...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-07-2015 a las 05:39:44
...
(1, 3, 'HTML', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla rhoncus velit et mi condimentum dignissim. Pellentesque vulputate convallis lacus eget venenatis. Integer non tristique lectus, vitae ullamcorper ex. Ut eu finibus massa, ac volutpat dui. Sed nisi eros, aliquam a gravida elementum, finibus vel tellus. Maecenas maximus commodo sem eu hendrerit. Aliquam lacinia rutrum ipsum, vel eleifend tortor fermentum  ', '0', 1);
...
(11, 'renato96', 8, '2015-07-11 00:00:00');
...
(1, 1, 'title', 'eryu', 'vhnfgkj', NULL, 3, 1);
...
(1, 3, 1, 10, '2015-07-10 23:13:40', '2015-07-10 23:13:50', '00:00:10');
...
--
-- Indices de la tabla `curden`
--
ALTER TABLE `curden`
 ADD PRIMARY KEY (`id`), ADD KEY `idCur` (`idCur`,`idUsrDen`);

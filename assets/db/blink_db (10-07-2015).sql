...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-07-2015 a las 23:52:22
...
INSERT INTO `curden` (`id`, `idCur`, `idUsr`, `fecha_den`) VALUES
(1, 1, 18, '2015-07-10 15:33:49');
...
--
ALTER TABLE `curden`
 ADD PRIMARY KEY (`id`), ADD KEY `idCur` (`idCur`,`idUsr`);

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-04-2015 a las 09:31:04
...
(1, 3, 'Maquetacion Web Basica', 'Maquetacion Web Basica Maquetacion Web Basica Maquetacion Web Basica', NULL, '1'),
(2, 3, 'Basic Web Layout', 'Basic Web Layout Basic Web Layout Basic Web Layout Basic Web Layout', NULL, '1'),
(3, 1, 'HTML ', 'hola', NULL, '1'),
(4, 12, 'curso basico', 'descripcion', NULL, '1'),
(5, 17, 'Test', 'This is a test  ', NULL, '1');
...
(6, 5, 'Lesson Test', 'Test', 'You may try to built this correctly', NULL);
...
--
ALTER TABLE `leccion`
MODIFY `idleccion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--

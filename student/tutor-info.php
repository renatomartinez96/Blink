            ...
            margin-top:15px;
                        ...
                        <div class="panel col-xs-12 full">
                            <div class="panel-heading full" style="border-bottom: 0px;">
                                <div class="jumbotron text-center" id="usrpanel" style="margin-bottom: 0px;">
                                    <img src="../assets/img/avatares/<?=$avatar1?>.png" style="border-radius:50%;width:15%;background: rgba(255, 255, 255, 0.4);">
                                    <h2 class="junction-bold"><?=$nombres1?> <?=$apellidos1?></h2>
                                    <h3 class="junction-bold"><?=$usuario1?> - <strong class="text-capitalize"><?=$langprint["tutor-type"]?></strong></h3>
                                    <h4 class="junction-light container"><?=$descripcion1?></h4>
                                    <a class="btn btn-success input-lg" target="_blank" href="../users/<?=$usuario1?>/index.html"><?=$langprint["the-page-of"]?> <Strong><?=$usuario1?></Strong></a>
                                </div>
                            </div>
                        </div>
                         <div class="col-xs-12 full">
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                        <h3 class="panel-title text-center"><?=$langprint["navcourses"]?></h3>
                                </div>
                            </div>
                        </div>
                        <?php

<?php 
    ...
    $i = 0;
        ...
        $string .= "<div class='col-xs-10'>
                ...
                <div class='col-xs-1'><a class='btn btn-success botoncrear'>Crear curso</a></div>";
        while ($stmt->fetch()) {
             $string .= "<div class='col-xs-4 cursos'><div class='alert alert-dismissible alert-info'>
                    ...
                    <button type='submit'  name='loadLessons' value='".$idcurso."' class='btn btn-primary loadLessons'>Ver lecciones</button>

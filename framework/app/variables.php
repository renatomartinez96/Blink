...
"<div id='' class='col-sm-10 col-sm-offset-1 fullo bg-warning A S' ><div class='col-xs-12 full text-center'><h4>SRC</h4></div><div class='col-xs-12 full'><select class='form-control '>"+"<?php opendire($dir); ?> "+"</select></div></div>",
